		...
		if (name.equals(user.getName()) && pass.equals(user.getPassword())) {
			...
			while (enu.hasMoreElements()) {
				...
				if (radioButton.getName() == "manage" && radioButton.isSelected()) {
					...
					this.dispose();
				} else if (radioButton.getName() == "order" && radioButton.isSelected()) {
					java.awt.EventQueue.invokeLater(new Runnable() {
						public void run() {
					...
					this.dispose();
				} else if (radioButton.getName() == "ordering" && radioButton.isSelected()) {
					java.awt.EventQueue.invokeLater(new Runnable() {
						public void run() {
					...
					this.dispose();
				} else if (radioButton.getName() == "orderCheck" && radioButton.isSelected()) {
					java.awt.EventQueue.invokeLater(new Runnable() {
						public void run() {
