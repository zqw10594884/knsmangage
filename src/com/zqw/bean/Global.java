...
public class Global {
	...
	//
	// public static List<CurtainShopGoods> CSGLst = (List<CurtainShopGoods>)
	// DBUtil
	// .getLstClass("", "", CurtainShopGoods.class, "");
	//
	// public static List<CurtainCustomer> CCLst = (List<CurtainCustomer>)
	// DBUtil
