...
public class JListCheckBoxDemo extends JFrame implements ActionListener {
	...
	public JListCheckBoxDemo() {
		...
		cli = new CheckListItem[] { new CheckListItem("1"), new CheckListItem("2"), new CheckListItem("3"), new CheckListItem("4"),
				new CheckListItem("5"), new CheckListItem("6"), new CheckListItem("7"), new CheckListItem("8"), new CheckListItem("9") };
