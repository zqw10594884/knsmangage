...
public class knsJFreeChart extends ApplicationFrame {
	...
	public knsJFreeChart(String title) {
		super(title);
	}
	...
	private void initComponents() {
		...
		this.setContentPane(cp); // 构造函数中自动创建Java的panel面板
	}
	...
	public static void main(String[] args) {
		...
		knsJFreeChart chart = new knsJFreeChart("某公司组织结构图");
		chart.setDatasetLst(datasetLstTest);
